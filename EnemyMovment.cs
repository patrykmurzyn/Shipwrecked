...
public class EnemyMovment : MonoBehaviour
{
    ...
    public static float CheckDistanceToPlayer(int temp)
    {
        float distance = Vector2.Distance(new Vector2(Box.GetBoxes(temp).GetBoxObject().transform.position.x, Box.GetBoxes(temp).GetBoxObject().transform.position.z),
            new Vector2(PlayerManage.GetPlayerObject().transform.position.x, PlayerManage.GetPlayerObject().transform.position.z));
    ...
    private void GoUP()
    {
        ...
        Box.GetBoxes(Enemy.GetEnemies(index).GetPosition()).SetState(0);
        ...
        Box.GetBoxes(Enemy.GetEnemies(index).GetPosition()).SetState(5);
